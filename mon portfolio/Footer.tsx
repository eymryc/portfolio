...
export default function Footer() {
  return (
    <footer className="py-12 px-6 text-center border-t border-white/5 backdrop-blur-sm" style={{ background: "rgba(8,12,20,0.5)" }}>
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white font-semibold text-sm">Romaric Ouangni</span>
          </div>
