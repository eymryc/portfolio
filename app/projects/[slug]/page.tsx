...
const PROJECTS: Record<string, any> = {
  ...
  "jumphost-securise": {
    ...
    longDesc: "Mise en place d'une infrastructure sécurisée permettant l'accès distant aux serveurs via un jumphost. L'architecture inclut l'authentification SSO, la gestion des certificats SSL automatisée et un reverse proxy pour la sécurité renforcée. Le système permet un accès sécurisé depuis n'importe où avec audit complet des sessions.",
    category: "DevOps",
    icon: "🔐",
    color: "#EF4444",
    tags: ["Docker", "Keycloak", "Nginx", "Certbot", "OpenID Connect", "Guacamole", "SSL/TLS"],
    features: [
      "Authentification SSO via Keycloak",
      "Guacamole pour accès distant sécurisé",
      "Reverse proxy Nginx avec rate limiting",
      "Certificats SSL/TLS automatisés avec Certbot",
      "Architecture Docker complète",
      "Audit et logging des sessions",
      "Multi-factor authentication",
    ],
    challenges: [
      "Sécuriser l'accès distant sans compromettre la facilité d'utilisation",
      "Automatiser le renouvellement des certificats SSL",
      "Gérer les permissions granulaires",
    ],
    solutions: [
      "Intégration Keycloak pour gestion centralisée des identités",
      "Scripts d'automatisation pour Certbot",
      "Politiques d'accès basées sur les rôles",
    ],
    results: [
      "100% des accès sécurisés",
      "Réduction de 80% du temps de gestion des accès",
      "Zéro incident de sécurité",
    ],
    techStack: {
      infrastructure: ["Docker", "Docker Compose", "Nginx", "Certbot"],
      security: ["Keycloak", "OpenID Connect", "OAuth 2.0", "SSL/TLS"],
      tools: ["Guacamole", "Prometheus", "Grafana"],
    },
    year: "2024",
    duration: "3 mois",
    team: "2 DevOps",
